        ...
        <div class="container">
            <div class="card">
                <div class="card-header">
                    <strong>Tambah Coffe</strong>
                </div>
                <div class="card-body card-block">
                    <?php
                    foreach ($tb_coffe as $detail) {
                    ?>

                        <form action="<?php echo site_url('coffe_controller/update_coffe_db'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="nama_coffe" class=" form-control-label">Nama Coffe</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="nama_coffe" name="nama_coffe" value="<?php echo $detail->nama_coffe; ?>" class="form-control"></div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="number" min="0" id="harga" name="harga" value="<?php echo $detail->harga; ?>" class="form-control"></div>
                            </div>
